// ======================================================================
// Keypad.v generated from TopDesign.cysch
// 05/01/2024 at 09:15
...
// Teclado(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Teclado, CY_CONFIG_TITLE=Teclado, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Teclado, CY_INSTANCE_SHORT_NAME=Teclado, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Teclado, )
module Teclado_0 (
    Clock,
    Interrupt);
    input       Clock;
    ...
    begin : LUT_2
        ...
        assign tmp__LUT_2_ins = {Net_73[3],Net_73[2],Net_73[1],Net_73[0]};
        ...
        assign {Interrupt,Net_75,Net_74} = tmp__LUT_2_reg;
    end
    // -- LUT LUT_2 end --
	...
	wire [3:0] tmpOE__Rows_net;
	wire [3:0] tmpIO_3__Rows_net;
	wire [0:0] tmpINTERRUPT_0__Rows_net;
	electrical [0:0] tmpSIOVREF__Rows_net;

	cy_psoc3_pins_v1_10
		#(.id("f5b62b96-cc6c-43da-b10d-473edd76a776/543d5cba-c818-41c0-b574-1ed215e93938"),
	...
	assign tmpOE__Rows_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
    ...
    begin : LUT_1
        ...
        assign tmp__LUT_1_ins = {Net_11,Net_10,Net_9,Net_7};
        always @(tmp__LUT_1_ins)
        begin
            case (tmp__LUT_1_ins)
                4'b0000 :  tmp__LUT_1_reg = 2'b00;
                4'b0001 :  tmp__LUT_1_reg = 2'b00;
                4'b0010 :  tmp__LUT_1_reg = 2'b00;
                4'b0011 :  tmp__LUT_1_reg = 2'b00;
                4'b0100 :  tmp__LUT_1_reg = 2'b00;
                4'b0101 :  tmp__LUT_1_reg = 2'b00;
                4'b0110 :  tmp__LUT_1_reg = 2'b00;
                4'b0111 :  tmp__LUT_1_reg = 2'b11;
                4'b1000 :  tmp__LUT_1_reg = 2'b00;
                4'b1001 :  tmp__LUT_1_reg = 2'b00;
                4'b1010 :  tmp__LUT_1_reg = 2'b00;
                4'b1011 :  tmp__LUT_1_reg = 2'b10;
                4'b1100 :  tmp__LUT_1_reg = 2'b00;
                4'b1101 :  tmp__LUT_1_reg = 2'b01;
                4'b1110 :  tmp__LUT_1_reg = 2'b00;
                4'b1111 :  tmp__LUT_1_reg = 2'b00;
            endcase
        end
        assign {Net_77,Net_76} = tmp__LUT_1_reg;
    end
    // -- LUT LUT_1 end --

	wire [3:0] tmpOE__Columns_net;
	wire [3:0] tmpIO_3__Columns_net;
	wire [0:0] tmpINTERRUPT_0__Columns_net;
	electrical [0:0] tmpSIOVREF__Columns_net;

	cy_psoc3_pins_v1_10
		#(.id("f5b62b96-cc6c-43da-b10d-473edd76a776/8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(12'b010_010_010_010),
		  .ibuf_enabled(4'b1_1_1_1),
		...
		Columns
		 (.oe(tmpOE__Columns_net),
		  .y({4'b0}),
		  .fb({Net_11, Net_10, Net_9, Net_7}),
		  .io({tmpIO_3__Columns_net[3:0]}),
	...
	assign tmpOE__Columns_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d61395f-7c84-42b0-aa8a-3112bc2b63a3/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("8aa40e76-053f-4925-b4ba-95802e0c49ff"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("1a8b571d-2b9c-4b8e-8790-6f946035be43"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("194e860e-2a8a-433f-8b54-af16c85ddeab"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000000"),
		  .is_direct(0),
